...
const FeaturedNews: React.FC = () => {
  ...
  const [selectedNews, setSelectedNews] = useState<FeaturedNews | null>(null);
  const [formData, setFormData] = useState({
    ...
    isFeatured: true, // Always true for featured news
    isBreaking: false,
    isTrending: false,
  ...
  const fetchFeaturedNews = async () => {
    try {
      ...
      if (response?.data) {
        // Filter for featured news on the client side
        const featuredArticles = response.data.filter(article => article.isFeatured);
        setFeaturedNews(featuredArticles as FeaturedNews[]);
        setTotalPages(Math.ceil((response.pagination?.total || featuredArticles.length) / itemsPerPage));
      }
    } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      data.append('isFeatured', 'true'); // Always true for featured news
      ...
      setFeaturedNews(prev => [newArticle as FeaturedNews, ...prev]);
      
      // Show success message
      setFormSuccess('Featured news article created successfully!');
  ...
  const handleDelete = async (id: string) => {
    try {
      ...
      setFeaturedNews(prev => prev.filter(article => article.id !== id));
  ...
  const toggleStatus = async (id: string, currentStatus: string) => {
    try {
      ...
      setFeaturedNews(prev => prev.map(article => 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Featured News</h1>
                <p className="text-sm text-gray-600">Manage premium and highlighted news articles</p>
                <div className="mt-2">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search featured news..."
                  value={searchTerm}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">No featured news</h3>
            <p className="mt-1 text-sm text-gray-500">Get started by creating your first featured news article.</p>
            <div className="mt-6">
              <button
                onClick={() => setShowAddModal(true)}
          ...
          <div className="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-medium text-gray-900">
                {showAddModal ? 'Add Featured News' : 'Edit Featured News'}
              </h3>
              <button
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Enter featured news title"
                  maxLength={200}
                />
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                  placeholder="Enter featured news content"
                />
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
                ...
                <ul className="text-xs text-blue-700 space-y-1">
                  ...
                  <li>• Featured news articles are automatically marked as featured</li>
                </ul>
              </div>
                ...
                >
                  {formLoading ? (
                    ...
                    <span className="flex items-center">
                      ...
                      {showAddModal ? 'Create Featured News' : 'Update Featured News'}
                    </span>
                  )}
                </button>
              </div>
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
          <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div className="mt-3 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mt-2">Delete Featured News</h3>
